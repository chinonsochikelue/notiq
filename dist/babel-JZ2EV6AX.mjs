          ...
          flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
            ...
            for (s && this.match(6) ? (this.expect(6), h = 9, c = true) : (this.expect(5), h = 8, c = false), l.exact = c; !this.match(h); ) {
              ...
              if (this.eat(0)) x != null && this.unexpected(x), this.eat(0) ? (S && this.unexpected(S.loc.start), l.internalSlots.push(this.flowParseObjectTypeInternalSlot(N, d))) : l.indexers.push(this.flowParseObjectTypeIndexer(N, d, S));
                ...
                let W = this.flowParseObjectTypeProperty(N, d, x, S, I, i, n != null ? n : !c);
...
`);
        ...
        function Ds(a, t, e, s, i, r, n, o, l, h) {
          ...
          for (let A = 0, N = r != null ? r : 1 / 0; A < N; ++A) {
        ...
        var br = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), O = class {
          ...
          unexpected(t, e) {
            throw this.raise(p.UnexpectedToken, t != null ? t : this.state.startLoc, { expected: e ? H(e) : null });
          }
          expectPlugin(t, e) {
        ...
        var Nr = (a) => class extends a {
          ...
          tsParseModifiers({ allowedModifiers: e, disallowedModifiers: s, stopOnStartOfClassStaticBlock: i, errorTemplate: r = y.InvalidModifierOnTypeMember }, n) {
            ...
            for (; ; ) {
              let { startLoc: h } = this.state, c = this.tsParseModifier(e.concat(s != null ? s : []), i, n.static);
              if (!c) break;
...
`);
      ...
      function v(a) {
        var _a2, _b;
        var s, i, r;
        let t = (_a2 = (s = a.range) == null ? void 0 : s[0]) != null ? _a2 : a.start, e = (r = (_b = (i = a.declaration) == null ? void 0 : i.decorators) != null ? _b : a.decorators) == null ? void 0 : r[0];
        return e ? Math.min(v(e), t) : t;
      }
      function k(a) {
        var _a2;
        var e;
        return (_a2 = (e = a.range) == null ? void 0 : e[1]) != null ? _a2 : a.end;
      }
      function Zr(a) {
        let t = new Set(a);
      ...
      function ea(a, t, e) {
        ...
        for (let i of a[/* @__PURE__ */ Symbol.for("comments")]) {
          let r = v(i);
          if (r > e) break;
          let n = k(i);
          if (n < t) continue;
...
`);
      ...
      function Te(a) {
        ...
        return ge = Te.prototype = a != null ? a : /* @__PURE__ */ Object.create(null), new Te();
      }
      var oa = 10;
        ...
        a = ei(a, (l) => {
          switch (l.type) {
            case "ParenthesizedExpression": {
              ...
              if (!u) return h.extra = __spreadProps(__spreadValues({}, h.extra), { parenthesized: true }), h;
              break;
            }
            ...
            case "TSTypeParameter":
              ...
              break;
            case "TopicReference":
              a.extra = __spreadProps(__spreadValues({}, a.extra), { __isUsingHackPipeline: true });
              break;
            case "TSUnionType":
            ...
            case "TSEnumDeclaration":
              if (!l.body) {
                let h = k(l.id), { members: c } = l, u = Js({ originalText: s, [/* @__PURE__ */ Symbol.for("comments")]: i }, h, c[0] ? v(c[0]) : k(l)), f = h + u.indexOf("{");
...
`;
      ...
      function ba(a) {
        return a = typeof a == "function" ? { parse: a } : a, __spreadValues({ astFormat: "estree", hasPragma: ui, hasIgnorePragma: fi, locStart: v, locEnd: k }, a);
      }
      var Y = ba;
      ...
      function Ia({ isExpression: a = false, optionsCombinations: t }) {
        return (e, s = {}) => {
          ...
          let r = t, n = (_a2 = s.__babelSourceType) != null ? _a2 : di(i);
          n === kt && (r = r.map((c) => __spreadProps(__spreadValues({}, c), { sourceType: n })));
          let o = /%[A-Z]/u.test(e);
      ...
      var ja = __spreadValues(__spreadValues({}, vt), Dt);
      return wi($a);
    });
  }
});
