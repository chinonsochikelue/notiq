...
// node_modules/.pnpm/prettier@3.6.2/node_modules/prettier/plugins/postcss.js
var require_postcss = __commonJS({
  "node_modules/.pnpm/prettier@3.6.2/node_modules/prettier/plugins/postcss.js"(exports, module) {
    init_react_shim();
    (function(f) {
      function e() {
        var i = f();
      ...
      var El = Object.getPrototypeOf, kl = Object.prototype.hasOwnProperty;
      var g = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), tn = (t, e) => {
        for (var s in e) Tt(t, s, { get: e[s], enumerable: true });
      }, rn = (t, e, s, r) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of _l(e)) !kl.call(t, n) && n !== s && Tt(t, n, { get: () => e[n], enumerable: !(r = bl(e, n)) || r.enumerable });
        return t;
      };
      var be = (t, e, s) => (s = t != null ? xl(El(t)) : {}, rn(e || !t || !t.__esModule ? Tt(s, "default", { value: t, enumerable: true }) : s, t)), Sl = (t) => rn(Tt({}, "__esModule", { value: true }), t);
      var Oi = g((Rv, is) => {
        var _ = String, Ti = function() {
        ...
        var Ci = Oi(), Ai = os(), at = class t extends Error {
          ...
          showSourceCode(e) {
            ...
            return o.slice(u, a).map((f, p) => {
              ...
              if (l === this.line) {
                if (f.length > 160) {
                  let h = 20, m = Math.max(0, this.column - h), y = Math.max(this.column + h, this.endColumn + h), b = f.slice(m, y), w = r(d.replace(/\d/g, " ")) + f.slice(0, Math.min(this.column - 1, h - 1)).replace(/[^\t]/g, " ");
                  return n(">") + r(d) + i(b) + `
 ` + w + n("^");
                }
...
`);
      ...
      var pt = g((Uv, qi) => {
        "use strict";
        var Oc = Yt(), Cc = Vt(), Ac = lt(), { isClean: ct, my: Nc } = zt();
        function ls(t, e) {
...
` ? (s = 1, r += 1) : s += 1;
        ...
        var ft = class {
          ...
          constructor(e = {}) {
            this.raws = {}, this[ct] = false, this[Nc] = true;
          ...
          positionBy(e = {}) {
            ...
            if (e.index) s = this.positionInside(e.index);
              ...
              let r = "document" in this.source.input ? this.source.input.document : this.source.input.css, i = r.slice(J(r, this.source.start), J(r, this.source.end)).indexOf(e.word);
...
` ? (s = 1, r += 1) : s += 1;
          ...
          rangeBy(e = {}) {
            ...
            } else e.start ? r = { column: e.start.column, line: e.start.line, offset: J(s, e.start) } : e.index && (r = this.positionInside(e.index)), e.end ? n = { column: e.end.column, line: e.end.line, offset: J(s, e.end) } : typeof e.endIndex == "number" ? n = this.positionInside(e.endIndex) : e.index && (n = this.positionInside(e.index + 1));
      ...
      var le = g((Wv, Vi) => {
        "use strict";
        var Mi = qe(), Bi = mt(), Ic = pt(), { isClean: Ui, my: Fi } = zt(), cs, $i, Wi, fs;
        function Gi(t) {
      ...
      var De = g((jv, eo) => {
        "use strict";
        var { nanoid: Mc } = Hi(), { isAbsolute: ms, resolve: ys } = {}, { SourceMapConsumer: Bc, SourceMapGenerator: Uc } = ji(), { fileURLToPath: Qi, pathToFileURL: Ht } = {}, Xi = Yt(), Fc = ps(), hs = os(), ds = /* @__PURE__ */ Symbol("lineToIndexCache"), $c = !!(Bc && Uc), Ji = !!(ys && ms);
        function Zi(t) {
          if (t[ds]) return t[ds];
          let e = t.css.split(`
`), s = new Array(e.length), r = 0;
        ...
        var Le = class {
          ...
          origin(e, s, r, n) {
            ...
            let a;
            ms(o.source) ? a = Ht(o.source) : a = new URL(o.source, this.map.consumer().sourceRoot || Ht(this.map.mapFile));
...
`, "	"];
        ...
        fo.exports = function(e, s = {}) {
          ...
          function F(W) {
            ...
            switch (i = r.charCodeAt(m), i) {
              ...
              case 64: {
                Qt.lastIndex = m + 1, Qt.test(r), Qt.lastIndex === 0 ? a = r.length - 1 : a = Qt.lastIndex - 2, f = ["at-word", r.slice(m, a + 1), m, a], m = a;
                break;
              }
              case 92: {
              ...
              default: {
                i === 47 && r.charCodeAt(m + 1) === 42 ? (a = r.indexOf("*/", m + 2) + 1, a === 0 && (n || T ? a = r.length : v("comment")), f = ["comment", r.slice(m, a + 1), m, a], m = a) : (Xt.lastIndex = m + 1, Xt.test(r), Xt.lastIndex === 0 ? a = r.length - 1 : a = Xt.lastIndex - 2, f = ["word", r.slice(m, a + 1), m, a], y.push(f), m = a);
                break;
              }
            }
            return m++, f;
      ...
      var Zt = g((ex, mo) => {
        "use strict";
        var Yc = jt(), Vc = qe(), zc = mt(), Hc = Be(), po = Kt(), jc = Jt(), ho = { empty: true, space: true };
        function Kc(t) {
...
`));
      ...
      var No = g((ux, Ao) => {
        var af = qe(), uf = Zt(), { isInlineComment: lf } = go(), { interpolation: Co } = vo(), { isMixinToken: cf } = bo(), ff = Eo(), pf = Oo(), hf = /(!\s*important)$/i;
        Ao.exports = class extends uf {
          ...
          mixin(e) {
            ...
            if ((n < 0 || n > 3) && i > 0) {
              let c = e.reduce((w, v, R) => v[0] === ")" ? R : w), p = e.slice(i, c + i).map((w) => w[1]).join(""), [l] = e.slice(i), d = [l[2], l[3]], [x] = e.slice(c, c + 1), h = [x[2], x[3]], m = ["brackets", p].concat(d, h), y = e.slice(0, i), b = e.slice(c + 1);
      ...
      var Bo = g((hx, Mo) => {
        "use strict";
        var vf = jt(), xf = qe(), bf = mt(), _f = De(), Ef = ps(), kf = Be(), Sf = Kt();
        function wt(t, e) {
          if (Array.isArray(t)) return t.map((n) => wt(n));
          let _a2 = t, { inputs: s } = _a2, r = __objRest(_a2, ["inputs"]);
          if (s) {
            e = [];
            for (let n of s) {
              let i = __spreadProps(__spreadValues({}, n), { __proto__: _f.prototype });
              i.map && (i.map = __spreadProps(__spreadValues({}, i.map), { __proto__: Ef.prototype })), e.push(i);
            }
          }
      ...
      var Es = g((wx, Go) => {
        ...
        Go.exports = function(e) {
          Wo[e] || (Wo[e] = true, typeof console < "u" && console.warn && console.warn(e));
        };
      });
      var Ts = g((xx, Ho) => {
        "use strict";
        var Of = le(), Cf = tr(), Af = bs(), Nf = gt(), Yo = rr(), Pf = Be(), Rf = lt(), { isClean: K, my: If } = zt(), vx = Es(), qf = { atrule: "AtRule", comment: "Comment", decl: "Declaration", document: "Document", root: "Root", rule: "Rule" }, Lf = { AtRule: true, AtRuleExit: true, Comment: true, CommentExit: true, Declaration: true, DeclarationExit: true, Document: true, DocumentExit: true, Once: true, OnceExit: true, postcssPlugin: true, prepare: true, Root: true, RootExit: true, Rule: true, RuleExit: true }, Df = { Once: true, postcssPlugin: true, prepare: true }, Fe = 0;
        function bt(t) {
          return typeof t == "object" && typeof t.then == "function";
        }
        function zo(t) {
          let e = false, s = qf[t.type];
          return t.type === "decl" ? e = t.prop.toLowerCase() : t.type === "atrule" && (e = t.name.toLowerCase()), e && t.append ? [s, s + "-" + e, Fe, s + "Exit", s + "Exit-" + e] : e ? [s, s + "-" + e, s + "Exit", s + "Exit-" + e] : t.append ? [s, Fe, s + "Exit"] : [s, s + "Exit"];
        }
        function Vo(t) {
          let e;
          return t.type === "document" ? e = ["Document", Fe, "DocumentExit"] : t.type === "root" ? e = ["Root", Fe, "RootExit"] : e = zo(t), { eventIndex: 0, events: e, iterator: 0, node: t, visitorIndex: 0, visitors: [] };
        }
        function ks(t) {
          return t[K] = false, t.nodes && t.nodes.forEach((e) => ks(e)), t;
        }
        var Ss = {}, fe = class t {
          get content() {
          ...
          constructor(e, s, r) {
            ...
            else if (s instanceof t || s instanceof Yo) n = ks(s.root), s.map && (typeof r.map > "u" && (r.map = {}), r.map.inline || (r.map.inline = false), r.map.prev = s.map);
            else {
              let i = Nf;
            ...
            this.result = new Yo(e, n, r), this.helpers = __spreadProps(__spreadValues({}, Ss), { postcss: Ss, result: this.result }), this.plugins = this.processor.plugins.map((i) => typeof i == "object" && i.prepare ? __spreadValues(__spreadValues({}, i), i.prepare(this.result)) : i);
          }
          async() {
          ...
          walkSync(e) {
            e[K] = true;
            let s = zo(e);
            for (let r of s) if (r === Fe) e.nodes && e.each((n) => {
              n[K] || this.walkSync(n);
            });
            else {
      ...
      var Ko = g((_x, jo) => {
        "use strict";
        var Mf = bs(), Bf = gt(), Uf = rr(), Ff = lt(), bx = Es(), _t = class {
          get content() {
      ...
      var Xo = g((Ex, Qo) => {
        "use strict";
        var $f = tr(), Wf = Ts(), Gf = Ko(), Yf = Be(), we = class {
          constructor(e = []) {
      ...
      var sr = g((kx, na) => {
        "use strict";
        var Jo = jt(), Zo = qe(), Vf = le(), zf = Yt(), ea = mt(), ta = tr(), Hf = Bo(), jf = De(), Kf = Ts(), Qf = gs(), Xf = pt(), Jf = gt(), Os = Xo(), Zf = rr(), ra = Be(), sa = Kt(), ep = lt(), tp = _s();
        function k(...t) {
...
https://evilmartians.com/chronicles/postcss-8-plugin-migration`));
      ...
      var oa = g((Sx, ia) => {
        var { Container: rp } = sr(), Cs = class extends rp {
          constructor(e) {
        ...
        ua.exports = function(e, s = {}) {
          ...
          function Q(T) {
            ...
            switch (i = r.charCodeAt(h), i) {
              ...
              case 64: {
                nr.lastIndex = h + 1, nr.test(r), nr.lastIndex === 0 ? o = r.length - 1 : o = nr.lastIndex - 2, d = ["at-word", r.slice(h, o + 1), h, o], h = o;
                break;
              }
              case 92: {
      ...
      var fa = g((Ox, ca) => {
        var { Comment: np } = sr(), ip = Zt(), op = oa(), ap = la(), As = class extends ip {
          atrule(e) {
            let s = e[1], r = e;
            for (; !this.tokenizer.endOfFile(); ) {
...
`)) break;
      ...
      var M = g((B) => {
        "use strict";
        B.__esModule = true;
        var Fx = B.TAG = "tag", $x = B.STRING = "string", Wx = B.SELECTOR = "selector", Gx = B.ROOT = "root", Yx = B.PSEUDO = "pseudo", Vx = B.NESTING = "nesting", zx = B.ID = "id", Hx = B.COMMENT = "comment", jx = B.COMBINATOR = "combinator", Kx = B.CLASS = "class", Qx = B.ATTRIBUTE = "attribute", Xx = B.UNIVERSAL = "universal";
      });
      var lr = g((ur, Ca) => {
        "use strict";
        ur.__esModule = true;
      ...
      var cu = g((Tr, lu) => {
        ...
        Tr.__esModule = true;
        Tr.default = Hd;
        var ru = 39, Md = 34, $s = 92, su = 47, St = 10, Ws = 32, Gs = 12, Ys = 9, Vs = 13, nu = 43, iu = 62, ou = 126, au = 124, Bd = 44, Ud = 40, Fd = 41, $d = 91, Wd = 93, Gd = 59, uu = 42, Yd = 58, Vd = 38, zd = 64, kr = /[ \n\t\r\{\(\)'"\\;/]/g, Sr = /[ \n\t\r\(\)\*:;@!&'"\+\|~>,\[\]\\]|\/(?=\*)/g;
        function Hd(t) {
          for (var e = [], s = t.css.valueOf(), r = void 0, n = void 0, i = void 0, o = void 0, u = void 0, a = void 0, c = void 0, f = void 0, p = void 0, l = void 0, d = void 0, x = s.length, h = -1, m = 1, y = 0, b = function(v, R) {
            ...
            switch (r = s.charCodeAt(y), r === St && (h = y, m += 1), r) {
              ...
              case Gs:
                n = y;
                do
                  n += 1, r = s.charCodeAt(n), r === St && (h = n, m += 1);
              ...
              case Md:
                i = r === ru ? "'" : '"', n = y;
                do
                  for (l = false, n = s.indexOf(i, n + 1), n === -1 && b("quote", i), d = n; s.charCodeAt(d - 1) === $s; ) d -= 1, l = !l;
                while (l);
                e.push(["string", s.slice(y, n + 1), m, y - h, m, n - h, y]), y = n;
                break;
              case zd:
                kr.lastIndex = y + 1, kr.test(s), kr.lastIndex === 0 ? n = s.length - 1 : n = kr.lastIndex - 2, e.push(["at-word", s.slice(y, n + 1), m, y - h, m, n - h, y]), y = n;
                break;
              case $s:
                for (n = y, c = true; s.charCodeAt(n + 1) === $s; ) n += 1, c = !c;
                r = s.charCodeAt(n + 1), c && r !== su && r !== Ws && r !== St && r !== Ys && r !== Vs && r !== Gs && (n += 1), e.push(["word", s.slice(y, n + 1), m, y - h, m, n - h, y]), y = n;
                break;
              default:
                r === su && s.charCodeAt(y + 1) === uu ? (n = s.indexOf("*/", y + 2) + 1, n === 0 && b("comment", "*/"), a = s.slice(y, n + 1), o = a.split(`
`), u = o.length - 1, u > 0 ? (f = m + u, p = n - o[u].length) : (f = m, p = h), e.push(["comment", a, m, y - h, f, n - p, y]), h = p, m = f, y = n) : (Sr.lastIndex = y + 1, Sr.test(s), Sr.lastIndex === 0 ? n = s.length - 1 : n = Sr.lastIndex - 2, e.push(["word", s.slice(y, n + 1), m, y - h, m, n - h, y]), y = n);
                break;
            }
            y++;
          }
      ...
      var hu = g((Or, pu) => {
        ...
        var Nm = (function() {
          function t(e) {
            ...
            return this.root.append(s), this.current = s, this.lossy ? this.tokens = (0, fu.default)({ safe: e.safe, css: e.css.trim() }) : this.tokens = (0, fu.default)(e), this.loop();
          }
          return t.prototype.attribute = function() {
            ...
            l.forEach(function(d, x) {
              ...
              var y = void 0;
              ~c.indexOf(d) ? y = new nm.default({ value: m.slice(1), source: { start: { line: n.currToken[2], column: n.currToken[3] + d }, end: { line: n.currToken[4], column: n.currToken[3] + (h - 1) } }, sourceIndex: n.currToken[6] + l[x] }) : ~f.indexOf(d) ? y = new um.default({ value: m.slice(1), source: { start: { line: n.currToken[2], column: n.currToken[3] + d }, end: { line: n.currToken[4], column: n.currToken[3] + (h - 1) } }, sourceIndex: n.currToken[6] + l[x] }) : y = new cm.default({ value: m, source: { start: { line: n.currToken[2], column: n.currToken[3] + d }, end: { line: n.currToken[4], column: n.currToken[3] + (h - 1) } }, sourceIndex: n.currToken[6] + l[x] }), n.newNode(y, s);
            }), this.position++;
...
` ? (r = 1, n += 1) : r += 1;
      ...
      var U = g((sb, wu) => {
        ...
        We.registerWalker = (t) => {
          let e = "walk" + t.name;
          e.lastIndexOf("s") !== e.length - 1 && (e += "s"), !We.prototype[e] && (We.prototype[e] = function(s) {
      ...
      var Ou = g((lb, Tu) => {
        "use strict";
        var $m = U(), Wm = z(), Nr = class extends Wm {
          constructor(e) {
      ...
      var Au = g((cb, Cu) => {
        "use strict";
        var Gm = U(), Ym = z(), Pr = class extends Ym {
          constructor(e) {
      ...
      var Pu = g((fb, Nu) => {
        "use strict";
        var Vm = U(), zm = z(), Rr = class extends zm {
          constructor(e) {
      ...
      var Du = g((hb, Lu) => {
        "use strict";
        var Hm = U(), jm = z(), qr = class extends jm {
          constructor(e) {
      ...
      var Bu = g((db, Mu) => {
        "use strict";
        var Km = U(), Qm = z(), Lr = class extends Qm {
          constructor(e) {
      ...
      var Fu = g((mb, Uu) => {
        "use strict";
        var Xm = U(), Jm = z(), Dr = class extends Jm {
          constructor(e) {
      ...
      var Wu = g((yb, $u) => {
        "use strict";
        var Zm = U(), ey = z(), Mr = class extends ey {
          constructor(e) {
      ...
      var Yu = g((gb, Gu) => {
        "use strict";
        var ty = U(), ry = z(), Br = class extends ry {
          constructor(e) {
      ...
      var zu = g((wb, Vu) => {
        "use strict";
        var sy = U(), ny = z(), Ur = class extends ny {
          constructor(e) {
      ...
      var Xu = g((xb, Qu) => {
        ...
        Qu.exports = function(e, s) {
          s = s || {};
          let r = [], n = e.valueOf(), i = n.length, o = -1, u = 1, a = 0, c = 0, f = null, p, l, d, x, h, m, y, b, w, v, R, F;
          function Q(T) {
          ...
          for (; a < i; ) {
            switch (p = n.charCodeAt(a), p === 10 && (o = a, u += 1), p) {
              ...
              case 34:
                d = p === 39 ? "'" : '"', l = a;
                do
                  for (v = false, l = n.indexOf(d, l + 1), l === -1 && Q("quote", d), R = l; n.charCodeAt(R - 1) === 92; ) R -= 1, v = !v;
                while (v);
                r.push(["string", n.slice(a, l + 1), u, a - o, u, l - o, a]), a = l;
                break;
              case 64:
                Fr.lastIndex = a + 1, Fr.test(n), Fr.lastIndex === 0 ? l = n.length - 1 : l = Fr.lastIndex - 2, r.push(["atword", n.slice(a, l + 1), u, a - o, u, l - o, a]), a = l;
                break;
              case 92:
                l = a, p = n.charCodeAt(l + 1), y && p !== 47 && p !== 32 && p !== 10 && p !== 9 && p !== 13 && p !== 12 && (l += 1), r.push(["word", n.slice(a, l + 1), u, a - o, u, l - o, a]), a = l;
                break;
              case 43:
              case 45:
              case 42:
...
`), h = x.length - 1, h > 0 ? (b = u + h, w = l - x[h].length) : (b = u, w = o), r.push(["comment", m, u, a - o, b, l - w, a]), o = w, u = b, a = l;
                  ...
                  let O = iy;
                  if (p >= 48 && p <= 57 && (O = Ge), O.lastIndex = a + 1, O.test(n), O.lastIndex === 0 ? l = n.length - 1 : l = O.lastIndex - 2, O === Ge || p === 46) {
                    let C = n.charCodeAt(l), xe = n.charCodeAt(l + 1), en = n.charCodeAt(l + 2);
                    (C === 101 || C === 69) && (xe === 45 || xe === 43) && en >= 48 && en <= 57 && (Ge.lastIndex = l + 2, Ge.test(n), Ge.lastIndex === 0 ? l = n.length - 1 : l = Ge.lastIndex - 2);
                  }
      ...
      var _e = "string", Ye = "array", Ve = "cursor", re = "indent", Ee = "align", ze = "trim", se = "group", ne = "fill", ie = "if-break", He = "indent-if-break", ke = "line-suffix", je = "line-suffix-boundary", H = "line", Ke = "label", Se = "break-parent", Ot = /* @__PURE__ */ new Set([Ve, re, Ee, ze, se, ne, ie, He, ke, je, H, Ke, Se]);
      var Ol = (t, e, s) => {
...
Expected it to be ${r}.`;
      ...
      function L(t, e = {}) {
        return oe(t), Qe(e.expandedStates, true), { type: se, id: e.id, contents: t, break: !!e.shouldBreak, expandedStates: e.expandedStates };
      }
      function an(t) {
      ...
      function Ct(t, e = "", s = {}) {
        return oe(t), e !== "" && oe(e), { type: ie, breakContents: t, flatContents: e, groupId: s.groupId };
      }
      function un(t) {
        return oe(t), { type: ke, contents: t };
      }
      var Xe = { type: Se };
      var ql = { type: H, hard: true };
      var A = { type: H }, D = { type: H, soft: true }, S = [ql, Xe];
      function G(t, e) {
        oe(t), Qe(e);
        let s = [];
      ...
      var At = "'", fn = '"';
      function Dl(t, e) {
        let s = e === true || e === At ? At : fn, r = s === At ? fn : At, n = 0, i = 0;
        for (let o of t) o === s ? n++ : o === r && i++;
        return n > i ? r : s;
      }
      var pn = Dl;
      function Ml(t, e, s) {
        let r = e === '"' ? "'" : '"', i = E(false, t, new RegExp(`\\\\(.)|(["'])`, "gsu"), (o, u, a) => u === r ? u : a === e ? "\\" + a : a || (s && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/u.test(u) ? u : "\\" + u));
        return e + i + e;
      }
      var hn = Ml;
      function Bl(t, e) {
        cn.ok(new RegExp(`^(?<quote>["']).*\\k<quote>$`, "su").test(t));
        ...
        return t.charAt(0) === r ? t : hn(s, r, false);
      }
      var Nt = Bl;
      ...
      function mn(t, e, s) {
        if (Oe(t) && t.language === "yaml" && delete e.value, t.type === "css-comment" && s.type === "css-root" && s.nodes.length > 0 && ((s.nodes[0] === t || Oe(s.nodes[0]) && s.nodes[1] === t) && (delete e.text, /^\*\s*@(?:format|prettier)\s*$/u.test(t.text)) || s.type === "css-root" && $(false, s.nodes, -1) === t)) return null;
      ...
      function Ze(t) {
        ...
        return Je = Ze.prototype = t != null ? t : /* @__PURE__ */ Object.create(null), new Ze();
      }
      var Gl = 10;
...
`, s) + 1;
      ...
      var Xg = Pt(/\s/u), Rt = Pt(" 	"), En = Pt(",; 	"), It = Pt(/[^\n\r]/u);
      function kn(t, e) {
        let { value: s } = t;
      ...
      function Sn(t, e) {
        ...
        if (typeof t.sourceIndex == "number") return t.type === "value-word" ? kn(t, t.sourceIndex) : t.sourceIndex;
      ...
      function Kr(t, e) {
        ...
        if (t.source) {
          ...
          if (ue(t.nodes)) return Kr($(false, t.nodes, -1), e);
        }
        return null;
      }
      function Qr(t, e) {
        ...
        for (let s in t) {
          let r = t[s];
          s === "source" || !r || typeof r != "object" || (r.type === "value-root" || r.type === "value-unknown" ? Tn(r, jl(t), r.text || r.value) : Qr(r, e));
        }
      }
      function Tn(t, e, s) {
...
` || u === "\r") && (n && i.push([r, o]), e = "initial", n = false);
      ...
      function qn(t) {
        let e = t.match(Pn), s = e == null ? void 0 : e[0];
...
`;
        ...
        let r = /* @__PURE__ */ Object.create(null), n = E(false, t, An, "").replace(Cn, "").trimEnd(), i;
        for (; i = An.exec(t); ) {
      ...
      function Dn({ comments: t = "", pragmas: e = {} }) {
        let s = `
`, r = "/**", n = " *", i = " */", o = Object.keys(e), u = o.flatMap((c) => Nn(c, e[c])).map((c) => `${n} ${c}${s}`).join("");
        if (!t) {
...
`);
      ...
      function Gn(t) {
        let { shebang: e, text: s, pragmas: r, comments: n } = Xr(t), i = qn(s), o = Dn({ pragmas: __spreadValues({ [Un]: "" }, r), comments: n.trimStart() });
        return (e ? `${e}
` : "") + o + (i.startsWith(`
`) ? `
` : `
...
...`, s)), n === -1) return;
        ...
        let a = t.slice(0, o);
        return { type: "front-matter", language: i, explicitLanguage: r, value: t.slice(s + 1, n), startDelimiter: e, endDelimiter: a.slice(-et), raw: a };
      }
      function rc(t) {
        let e = tc(t);
...
` : "") + Gn(s);
      ...
      function Jr(t) {
        var e;
        return t.type === "value-paren_group" && ((e = t.groups) == null ? void 0 : e[0]) && Mt(t.groups[0]);
      }
      function es(t, e) {
        var i;
      ...
      function oc(t, e, s) {
        var m;
        let { node: r } = t, n = t.parent, i = t.grandparent, o = Hn(t), u = o && n.type === "value-value" && (o === "grid" || o.startsWith("grid-template")), a = t.findAncestor((y) => y.type === "css-atrule"), c = a && rt(a, e), f = r.groups.some((y) => Pe(y)), p = t.map(s, "groups"), l = [""], d = Ne(t, "url"), x = false, h = false;
        for (let y = 0; y < r.groups.length; ++y) {
          let b = r.groups[y - 1], w = r.groups[y], v = r.groups[y + 1], R = r.groups[y + 2];
          if (Pe(w) && !v) {
            l.push([l.pop(), un([" ", p[y]])]);
            continue;
          }
          ...
          if (nt(v) && w.type === "value-word" && l.length > 2 && r.groups.slice(0, y).every((C) => C.type === "value-comment") && !Pe(b) && (l[l.length - 2] = ae($(false, l, -2))), he(t, "forward") && w.type === "value-word" && w.value && b !== void 0 && b.type === "value-word" && b.value === "as" && v.type === "value-operator" && v.value === "*" || he(t, "utility") && w.type === "value-word" && v && v.type === "value-operator" && v.value === "*" || !v || w.type === "value-word" && it(v) && P(w) === N(v)) continue;
          if (w.type === "value-string" && w.quoted) {
            let C = w.value.lastIndexOf("#{"), xe = w.value.lastIndexOf("}");
            C !== -1 && xe !== -1 ? x = C > xe : C !== -1 ? x = true : xe !== -1 && (x = false);
          }
          if (x || nt(w) || nt(v) || w.type === "value-atword" && (w.value === "" || w.value.endsWith("[")) || v.type === "value-word" && v.value.startsWith("]") || w.value === "~" || w.type !== "value-string" && w.value && w.value.includes("\\") && v && v.type !== "value-comment" || b != null && b.value && b.value.indexOf("\\") === b.value.length - 1 && w.type === "value-operator" && w.value === "/" || w.value === "\\" || ai(w, v) || Bt(w) || ts(w) || Ut(v) || ts(v) && me(v) || Ut(w) && me(v) || w.value === "--" && Bt(v)) continue;
          let F = Lt(w), Q = Lt(v);
          if ((F && Bt(v) || Q && Ut(w)) && me(v) || !b && tt(w) || Ne(t, "calc") && (X(w) || X(v) || de(w) || de(v)) && me(v)) continue;
          let W = (X(w) || de(w)) && y === 0 && (v.type === "value-number" || v.isHex) && i && pi(i) && !me(v), T = (R == null ? void 0 : R.type) === "value-func" || R && st(R) || w.type === "value-func" || st(w), O = v.type === "value-func" || st(v) || (b == null ? void 0 : b.type) === "value-func" || b && st(b);
          if (e.parser === "scss" && F && w.value === "-" && v.type === "value-func" && P(w) !== N(v)) {
            l.push([l.pop(), " "]);
            continue;
          }
          if (!(!(qt(v) || qt(w)) && !Ne(t, "calc") && !W && (tt(v) && !T || tt(w) && !O || X(v) && !T || X(w) && !O || de(v) || de(w)) && (me(v) || F && (!b || b && Lt(b)))) && !((e.parser === "scss" || e.parser === "less") && F && w.value === "-" && ot(v) && P(w) === N(v.open) && v.open.value === "(")) {
            if (Pe(w)) {
            ...
            if ((v == null ? void 0 : v.value) !== "..." && !(it(w) && it(v) && P(w) === N(v))) {
              ...
              (m = w.value) != null && m.endsWith("#") && v.value === "{" && ot(v.group) || Pe(v) && !R || l.push(A, "");
            }
          }
        }
        return f && l.push([l.pop(), Xe]), h && l.unshift("", S), c ? L(q(l)) : Xn(t) ? L(Te(l)) : L(q(Te(l)));
      }
      var di = oc;
      function ac(t) {
      ...
      var mi = ac;
      var Ft = /* @__PURE__ */ new Map([["em", "em"], ["rem", "rem"], ["ex", "ex"], ["rex", "rex"], ["cap", "cap"], ["rcap", "rcap"], ["ch", "ch"], ["rch", "rch"], ["ic", "ic"], ["ric", "ric"], ["lh", "lh"], ["rlh", "rlh"], ["vw", "vw"], ["svw", "svw"], ["lvw", "lvw"], ["dvw", "dvw"], ["vh", "vh"], ["svh", "svh"], ["lvh", "lvh"], ["dvh", "dvh"], ["vi", "vi"], ["svi", "svi"], ["lvi", "lvi"], ["dvi", "dvi"], ["vb", "vb"], ["svb", "svb"], ["lvb", "lvb"], ["dvb", "dvb"], ["vmin", "vmin"], ["svmin", "svmin"], ["lvmin", "lvmin"], ["dvmin", "dvmin"], ["vmax", "vmax"], ["svmax", "svmax"], ["lvmax", "lvmax"], ["dvmax", "dvmax"], ["cm", "cm"], ["mm", "mm"], ["q", "Q"], ["in", "in"], ["pt", "pt"], ["pc", "pc"], ["px", "px"], ["deg", "deg"], ["grad", "grad"], ["rad", "rad"], ["turn", "turn"], ["s", "s"], ["ms", "ms"], ["hz", "Hz"], ["khz", "kHz"], ["dpi", "dpi"], ["dpcm", "dpcm"], ["dppx", "dppx"], ["x", "x"], ["cqw", "cqw"], ["cqh", "cqh"], ["cqi", "cqi"], ["cqb", "cqb"], ["cqmin", "cqmin"], ["cqmax", "cqmax"], ["fr", "fr"]]);
      function rs(t) {
        let e = t.toLowerCase();
        return Ft.has(e) ? Ft.get(e) : t;
      }
      var yi = new RegExp(`(["'])(?:(?!\\1)[^\\\\]|\\\\.)*\\1`, "gsu"), uc = /(?:\d*\.\d+|\d+\.?)(?:e[+-]?\d+)?/giu, lc = /[a-z]+/giu, cc = /[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/giu, fc = new RegExp(yi.source + `|(${cc.source})?(${uc.source})(${lc.source})?`, "giu");
      function Y(t, e) {
        return E(false, t, yi, (s) => Nt(s, e));
      }
      function gi(t, e) {
        let s = e.singleQuote ? "'" : '"';
      ...
      function ye(t) {
        return E(false, t, fc, (e, s, r, n, i) => !r && n && (i != null ? i : i = "", i = i.toLowerCase(), !i || i === "n" || Ft.has(i)) ? ss(n) + (i ? rs(i) : "") : e);
      }
      function ss(t) {
...
` || n === "\r" || n === "\u2028" || n === "\u2029") return e + 1;
      ...
      var $t = pc;
      function hc(t, e, s = {}) {
        let r = Rt(t, s.backwards ? e - 1 : e, s), n = $t(t, r, s);
        return r !== n;
      }
      var Wt = hc;
      function dc(t, e) {
      ...
      function yc(t, e) {
        ...
        return r = xi(t, r), r = $t(t, r), r !== false && Wt(t, r);
      }
      var Gt = yc;
      ...
      function wc(t, e) {
        return Zn(t.grandparent) && gc(t, e) ? "," : t.node.type !== "value-comment" && !(t.node.type === "value-comma_group" && t.node.groups.every((s) => s.type === "value-comment")) && wi(e) && t.callParent(() => es(t, e)) ? Ct(",") : "";
      }
      function bi(t, e, s) {
        let { node: r, parent: n } = t, i = t.map(({ node: d }) => typeof d == "string" ? d : s(), "groups");
        if (n && Jn(n) && (r.groups.length === 1 || r.groups.length > 0 && r.groups[0].type === "value-comma_group" && r.groups[0].groups.length > 0 && r.groups[0].groups[0].type === "value-word" && r.groups[0].groups[0].value.startsWith("data:"))) return [r.open ? s("open") : "", G(",", i), r.close ? s("close") : ""];
        if (!r.open) {
          let d = ns(t);
          Qe(i);
          let x = xc(G(",", i), 2), h = G(d ? S : A, x);
          return q(d ? [S, h] : L([vc(t) ? D : "", Te(h)]));
        }
        let o = t.map(({ node: d, isLast: x, index: h }) => {
          var b;
          let m = i[h];
          Mt(d) && d.type === "value-comma_group" && d.groups && d.groups[0].type !== "value-paren_group" && ((b = d.groups[2]) == null ? void 0 : b.type) === "value-paren_group" && j(m) === se && j(m.contents) === re && j(m.contents.contents) === ne && (m = L(ae(m)));
          let y = [m, x ? wc(t, e) : ","];
          if (!x && d.type === "value-comma_group" && ue(d.groups)) {
            let w = $(false, d.groups, -1);
            !w.source && w.close && (w = w.close), w.source && Gt(e.originalText, P(w)) && y.push(S);
          }
          return y;
        }, "groups"), u = ci(r, n), a = hi(r, n), c = es(t, e), f = a || c && !u, p = a || u, l = L([r.open ? s("open") : "", q([D, G(A, o)]), D, r.close ? s("close") : ""], { shouldBreak: f });
        return p ? ae(l) : l;
      }
      function ns(t) {
      ...
      function bc(t, e, s) {
        ...
        return t.each(() => {
          ...
          let { next: o } = t;
          o.type === "css-comment" && !Wt(e.originalText, N(o), { backwards: true }) && !Oe(n) || o.type === "css-atrule" && o.name === "else" && n.type !== "css-comment" ? r.push(" ") : (r.push(e.__isHTMLStyleAttribute ? A : S), Gt(e.originalText, P(n)) && !Oe(n) && r.push(S));
        }, "nodes"), r;
      }
      var Ie = bc;
      function _c(t, e, s) {
        ...
        switch (r.type) {
          case "front-matter":
            return [r.raw, S];
          case "css-root": {
            let f = Ie(t, e, s), p = r.raws.after.trim();
          ...
          case "css-rule":
            return [s("selector"), r.important ? " !important" : "", r.nodes ? [((n = r.selector) == null ? void 0 : n.type) === "selector-unknown" && Re(r.selector.value) ? A : r.selector ? " " : "", "{", r.nodes.length > 0 ? q([S, Ie(t, e, s)]) : "", S, "}", ei(r) ? ";" : ""] : ";"];
          case "css-decl": {
            ...
            return h = ui(r) ? sn(h) : h, !d && Re(l) && !((o = (i = r.value) == null ? void 0 : i.group) != null && o.group && t.call(() => ns(t), "value", "group", "group")) && (h = q([S, ae(h)])), [E(false, r.raws.before, /[\s;]/gu, ""), f.type === "css-atrule" && f.variable || Qn(t) ? r.prop : Ae(r.prop), l.startsWith("//") ? " " : "", l, r.extend || x ? "" : " ", e.parser === "less" && r.extend && r.selector ? ["extend(", s("selector"), ")"] : "", h, r.raws.important ? r.raws.important.replace(/\s*!\s*important/iu, " !important") : r.important ? " !important" : "", r.raws.scssDefault ? r.raws.scssDefault.replace(/\s*!default/iu, " !default") : r.scssDefault ? " !default" : "", r.raws.scssGlobal ? r.raws.scssGlobal.replace(/\s*!global/iu, " !global") : r.scssGlobal ? " !global" : "", r.nodes ? [" {", q([D, Ie(t, e, s)]), D, "}"] : oi(r) && !f.raws.semicolon && e.originalText[P(r) - 1] !== ";" ? "" : e.__isHTMLStyleAttribute && t.isLast ? Ct(";") : ";"];
          }
          case "css-atrule": {
            let f = t.parent, p = Dt(r) && !f.raws.semicolon && e.originalText[P(r) - 1] !== ";";
            if (e.parser === "less") {
          ...
          case "media-feature":
            return Ae(Y(E(false, r.value, / +/gu, " "), e));
          case "media-colon":
            return [r.value, " "];
          case "media-value":
            return ye(Y(r.value, e));
          case "media-keyword":
            return Y(r.value, e);
          case "media-url":
            return Y(E(false, E(false, r.value, /^url\(\s+/giu, "url("), /\s+\)$/gu, ")"), e);
          case "media-unknown":
            return r.value;
          case "selector-root":
            return L([he(t, "custom-selector") ? [t.findAncestor((f) => f.type === "css-atrule").customSelector, A] : "", G([",", he(t, ["extend", "custom-selector", "nest"]) ? A : S], t.map(s, "nodes"))]);
          ...
          case "selector-string":
            return Y(r.value, e);
          case "selector-tag":
            return [r.namespace ? [r.namespace === true ? "" : r.namespace.trim(), "|"] : "", ((a = t.previous) == null ? void 0 : a.type) === "selector-nesting" ? r.value : ye(Kn(t, r.value) ? r.value.toLowerCase() : r.value)];
          case "selector-id":
            return ["#", r.value];
          case "selector-class":
            return [".", ye(Y(r.value, e))];
          case "selector-attribute":
            return ["[", r.namespace ? [r.namespace === true ? "" : r.namespace.trim(), "|"] : "", r.attribute.trim(), (_a2 = r.operator) != null ? _a2 : "", r.value ? gi(Y(r.value.trim(), e), e) : "", r.insensitive ? " i" : "", "]"];
          case "selector-combinator": {
            if (r.value === "+" || r.value === ">" || r.value === "~" || r.value === ">>>") {
              let l = t.parent;
              return [l.type === "selector-selector" && l.nodes[0] === r ? "" : A, r.value, t.isLast ? "" : " "];
            }
            let f = r.value.trim().startsWith("(") ? A : "", p = ye(Y(r.value.trim(), e)) || A;
            return [f, p];
          }
          case "selector-universal":
            return [r.namespace ? [r.namespace === true ? "" : r.namespace.trim(), "|"] : "", r.value];
          case "selector-pseudo":
            return [Ae(r.value), ue(r.nodes) ? L(["(", q([D, G([",", A], t.map(s, "nodes"))]), D, ")"]) : ""];
          ...
          case "value-colon": {
            let { previous: f } = t;
            return L([r.value, typeof (f == null ? void 0 : f.value) == "string" && f.value.endsWith("\\") || Ne(t, "url") ? "" : A]);
          }
          case "value-string":
      ...
      var Ec = { print: _c, embed: vn, insertPragma: zn, massageAstNode: yn, getVisitorKeys: _n }, _i = Ec;
      ...
      var hl = be(gt(), 1), dl = be(Io(), 1), ml = be(ha(), 1);
      function cp(t, e) {
      ...
      function Z(t, e, s) {
        if (t && typeof t == "object") {
          delete t.parent;
          for (let r in t) Z(t[r], e, s), r === "type" && typeof t[r] == "string" && !t[r].startsWith(e) && (!s || !s.test(t[r])) && (t[r] = e + t[r]);
        }
        return t;
      }
      function Ms(t) {
      ...
      function Ty(t) {
        return $r(t).text.slice(t.group.open.sourceIndex + 1, t.group.close.sourceIndex).trim();
      }
      var nl = Ty;
      function Oy(t) {
        if (ue(t)) {
      ...
      function Ny(t, e) {
        ...
        for (let c = 0; c < s.length; ++c) {
          let f = s[c];
          if (e.parser === "scss" && f.type === "number" && f.unit === ".." && f.value.endsWith(".") && (f.value = f.value.slice(0, -1), f.unit = "..."), f.type === "func" && f.value === "selector" && (f.group.groups = [te($r(t).text.slice(f.group.open.sourceIndex + 1, f.group.close.sourceIndex))]), f.type === "func" && f.value === "url") {
      ...
      function Wr(t) {
        return t.type === "paren_group" && !t.open && !t.close && t.groups.length === 1 || t.type === "comma_group" && t.groups.length === 1 ? Wr(t.groups[0]) : t.type === "paren_group" || t.type === "comma_group" ? __spreadProps(__spreadValues({}, t), { groups: t.groups.map(Wr) }) : t;
      }
      function cl(t, e) {
        if (t && typeof t == "object") for (let s in t) s !== "parent" && (cl(t[s], e), s === "nodes" && (t.group = Wr(Ny(t, e)), delete t[s]));
        return t;
      }
      function Py(t, e) {
      ...
      var pl = qy;
      var Ly = /(\s*)(!default).*$/u, Dy = /(\s*)(!global).*$/u;
      function yl(t, e) {
        var _a2, _b, _c2, _d;
        var s, r;
        if (t && typeof t == "object") {
          ...
          let o = "";
          if (typeof t.params == "string" && (o = t.raws.params ? (_d = t.raws.params.scss) != null ? _d : t.raws.params.raw : t.params, t.raws.afterName && t.raws.afterName.trim().length > 0 && (o = t.raws.afterName + o), t.raws.between && t.raws.between.trim().length > 0 && (o = o + t.raws.between), o = o.trim(), t.raws.params = o), n.trim().length > 0) return n.startsWith("@") && n.endsWith(":") ? t : t.mixin ? (t.selector = pe(n, e), t) : (pl(t, e) && (t.isSCSSNesterProperty = true), t.selector = te(n), t);
          if (i.trim().length > 0) {
            let u = i.match(Ly);
          ...
          if (e.parser === "less" && t.type === "css-decl" && i.startsWith("extend(") && (t.extend || (t.extend = t.raws.between === ":"), t.extend && !t.selector && (delete t.value, t.selector = te(i.slice(7, -1)))), t.type === "css-atrule") {
            if (e.parser === "less") {
              if (t.mixin) {
            ...
            if (e.parser === "css" && t.name === "custom-selector") {
              ...
              return t.customSelector = u, t.selector = te(t.params.slice(u.length).trim()), delete t.params, t;
            }
            if (e.parser === "less") {
          ...
          if (t.type === "css-atrule" && o.length > 0) {
            ...
            return u === "warn" || u === "error" ? (t.params = { type: "media-unknown", value: o }, t) : u === "extend" || u === "nest" ? (t.selector = te(o), delete t.params, t) : u === "at-root" ? (new RegExp("^\\(\\s*(?:without|with)\\s*:.+\\)$", "su").test(o) ? t.params = pe(o, e) : (t.selector = te(o), delete t.params), t) : fl(a) ? (t.import = true, delete t.filename, t.params = pe(o, e), t) : ["namespace", "supports", "if", "else", "for", "each", "while", "debug", "mixin", "include", "function", "return", "define-mixin", "add-mixin"].includes(u) ? (o = o.replace(/(\$\S+?)(\s+)?\.{3}/u, "$1...$2"), o = o.replace(/^(?!if)(\S+)(\s+)\(/u, "$1($2"), t.value = pe(o, e), delete t.params, t) : ["media", "custom-media"].includes(a) ? o.includes("#{") ? { type: "media-unknown", value: o } : (t.params = _a(o), t) : (t.params = o, t);
          }
        }
        return t;
      }
      function Xs(t, e, s) {
        let r = Ce(e), { frontMatter: n } = r;
        e = r.content;
        let i;
        try {
          i = t(e, { map: false });
        ...
        return s.originalText = e, i = yl(Z(i, "css-"), s), Qr(i, e), n && (n.source = { startOffset: 0, endOffset: n.raw.length }, i.frontMatter = n), i;
      }
      function gl(t, e = {}) {
      ...
      var Js = { astFormat: "postcss", hasPragma: Yn, hasIgnorePragma: Vn, locStart: N, locEnd: P }, My = __spreadProps(__spreadValues({}, Js), { parse: gl }), By = __spreadProps(__spreadValues({}, Js), { parse: wl }), Uy = __spreadProps(__spreadValues({}, Js), { parse: vl });
      var Fy = { postcss: _i };
      return Sl($y);
    });
  }
